System.register(['angular2/core', './products/product-list.component', './products/product.service', './products/product-detail.component', './products/product-edit-form.component', './customers/customer-list.component', './customers/customer.service', './customers/customer-edit-form.component', './shopping/shopping-session-login.component', './shopping/shopping-cart.component', './shopping/shopping-report.component', './shopping/shopping-cart.service', './shopping/shopping-product-list.component', 'rxjs/Rx', 'angular2/http', 'angular2/router', './home/welcome.component', './shared/info.component'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (shopping_report_component_1_1) {
                shopping_report_component_1 = shopping_report_component_1_1;
            },
            ...
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/purchase-report/:customerId', name: 'PurchaseReport', component: shopping_report_component_1.ShoppingReportComponent },
                        ...
                        { path: '/info/:title/:message/:details', name: 'InfoComponent', component: info_component_1.InfoComponent }
                    ]), 
